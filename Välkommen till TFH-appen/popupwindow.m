...
{
    [[popupwindow alloc] initWithSuperview:view andFile:fileName];
}
...
{
    //faux view
    UIView* fauxView = [[[UIView alloc] initWithFrame: CGRectMake(10, 10, 100, 100)] autorelease];
    ...
    UIImageView* background = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"popupbg.png"]] autorelease];
    ...
    UILabel *ovning=[[UILabel alloc] initWithFrame:CGRectMake(10, 10, 20, 60)];
    ovning.font = [UIFont systemFontOfSize:12.0];
    ovning.textColor=[UIColor blackColor];
    ovning.numberOfLines = 4;
    ovning.text=@"selectedfasdgasdgfdgfsdgsgfdgdfsgsd";
    [bgView addSubview: ovning];
    [ovning release];
