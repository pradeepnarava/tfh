...
- (void)viewDidLoad
{
   ...
   text=@"";
    ...
    if(deviceIdiom==iPhone)
    {
        ...
        pickerOne.datePickerMode=UIDatePickerModeDateAndTime;
        ...
        pickerTwo.datePickerMode=UIDatePickerModeDateAndTime;
        ...
        pickerThree.datePickerMode=UIDatePickerModeDateAndTime;
        ...
        pickerFour.datePickerMode=UIDatePickerModeDateAndTime;
...
- (void)refreshEventsLoad
{
    ...
    for (int i = 0 ; i<[arrayEvents count]; i++) {
        NSLog(@"%u",[arrayEvents count]);
       
        
        EKEventStore *eventStore = [[EKEventStore alloc] init];
        EKEvent *events = [EKEvent eventWithEventStore:eventStore];
        events  = [arrayEvents objectAtIndex:i];
        NSLog(@"%@",events.eventIdentifier);
...
-(void)loadScheduleView
{
    ...
    for(int i=0;i<[arrayShowEvents count];i++)
    {
        ...
        UIButton *view1 = [[UIButton alloc]initWithFrame:CGRectMake(eventXPoint, eventYPoint, 39, 59)];
...
- (IBAction)closeBtn:(id)sender
{
    ...
    if ([messageEventTxtView.text length]&&[strDate length]) {
        ...
        NSLog(@"%@",messageEventTxtView.text);
        UIButton *view1 = [[UIButton alloc]initWithFrame:CGRectMake((xAxies*40)+25, yAxies*60, 39, 59)];
        view1.backgroundColor = [UIColor grayColor];
